...
public class Constants {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({REQUEST_CODE_MORE, REQUEST_CODE_NEWS, REQUEST_CODE_SOCIAL, REQUEST_CODE_SYSTEM, REQUEST_DELETE_NOTIFICATION, REQUEST_CODE_WIDGET, REQUEST_STOP_BLURB, REQUEST_START_BLURB})
    ...
    public static final int REQUEST_START_BLURB = 9999;
}
